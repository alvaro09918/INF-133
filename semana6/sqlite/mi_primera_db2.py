#ESTE SCRIPT A DIFERENCIA DEL PRIMERO SE ADICIONO EL TRY CATH PARA QUE NO DE ERROR AL EJECUTAR Y TAMBIEN SE HIZO PERSISTENTE LOS DATOS
#AÑADIENDO CONN.COMMIT PARA LA PERSITENCIA, EL RESTO ES LO MISMO QUE LA PRIEMERA BD
